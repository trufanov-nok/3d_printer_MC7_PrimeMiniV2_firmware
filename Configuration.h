...
#define STRING_VERSION_CONFIG_H __DATE__ "13_11_2018 " __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(MC7,PrimeMiniV2)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "MC7PrimeMiniV2"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
 #define MACHINE_UUID "13_11_2018__2"
...
// JH//Ultimaker
    #define  DEFAULT_Kp 26.04//22.2
    #define  DEFAULT_Ki 3.68//1.08
    #define  DEFAULT_Kd 46.07//114
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,110}//{78.7402,78.7402,200.0*8/3,760*1.1} {31.79*2*1.205, 31.79*2*1.205, 2500, 51.54*2*1.087}  // default steps per unit for Ultimaker
...
#define DEFAULT_RETRACT_ACCELERATION  2000//1500   // X, Y, Z and E max acceleration in mm/s^2 for retracts
